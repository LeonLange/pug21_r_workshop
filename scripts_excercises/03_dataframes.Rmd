...
```{r}
mess_around[10, 70] <- "empty"
mess_around[10, 70] <- 862

```

1.6) Use the "mess around data frame" to overwrite the entire 1st column. We will solve this task together with the course, but first think about the following questions: How would you, in principle, overwrite the entire 1st column? What would you need to replace it with?
